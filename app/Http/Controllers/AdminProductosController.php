...
class AdminProductosController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($lista);
        return view('adminuser.productos.tablaProductos',
    ...
    public function store(Request $request)
    {
        ...
        $wow->precio_iva = $request->precio_venta*0.19;
        ...
        return redirect(url('/adminuser/productos'))->with('mensaje','Producto Agregado Correctamente!');
        dd($request);
    }
    ...
    public function edit($id)
    {
        ...
        return view('adminuser.productos.editarProducto',['producto' => $producto, 'marcas' => Marca::all(), 'categorias' => Categoria::all(), 'inventarios' => Inventario::all()]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(url('/adminuser/productos'))->with('mensaje','Producto: '.$producto->nombre.' se actualizó correctamente');
    }
    ...
    public function destroy($id)
    {
        $producto = Producto::findOrFail($id);
        Producto::destroy($id);
        return redirect(url('/adminuser/productos'))->with('mensaje','Producto: '.$producto->nombre.' se eliminó correctamente');
    }
}
