...
<div  class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/adminuser/productos')); ?>">
...
<form id="formEliminar" method="POST" action="<?php echo e(url('/adminuser/productos/')); ?>" enctype="multipart/form-data">
  <?php echo e(csrf_field()); ?>
...
<script>
    ...
    $(".btn-danger").click(function(){
      ...
      {
        $('#formEliminar').attr('action',"<?php echo e(url('/adminuser/productos/')); ?>"+'/'+$(this).val());
        $('#formEliminar').submit();
      }  
    });
