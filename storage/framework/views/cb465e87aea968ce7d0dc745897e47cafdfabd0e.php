<?php $__env->startSection('title','Ordenes de Trabajo | Administrador'); ?>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody id="bodyTabla">
                        ...
                        <tr>
                          <td><button value="<?php echo e($fila->id); ?>"  class="btn btn-danger btn-xs btnEliminar">Eliminar</button><a href="<?php echo e(url('/adminuser/ots').'/'.$fila->id.'/edit'); ?>"  class="btn btn-warning btn-xs ">Modificar</a></td>
                          ...
                          <td><a target="_blank" href="<?php echo e(url('adminuser/reporteCotizacion').'/'.$fila->cotizacion->id); ?>"  class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> Cotizacion</a><a target="_blank" href="<?php echo e(url('adminuser/reporteOt').'/'.$fila->id); ?>" class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> O.T</a></td>
...
<script>
  function aplicarFiltro(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(url('adminuser/filtrarOts')); ?>",
      ...
      success: function(json) {
        ...
        for(var i=0; i<data['ots'].length; i++){
          ...
          wea.row.add(['<a href="'+"<?php echo e(url('adminuser/ots')); ?>"+'/'+data['ots'][i].id+'/edit" class="btn btn-warning btn-xs">Modificar</a>',
                      ...
                      '<a target="_blank" href="<?php echo e(url("adminuser/reporteCotizacion")); ?>'+'/'+data['idcotizacion'][i]+'" class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> Cotizacion</a><a href="<?php echo e(url("adminuser/reporteOt")); ?>/'+data['ots'][i].id+'" class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> O.T</a>',
