  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="wow" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" role="form" method="POST" action="<?php echo e(url('/adminuser/cotizaciones').'/'.$cotizacion->id); ?>">
...
$('.flexdatalistproductos').flexdatalist({
     minLength: 1,
     searchIn: 'nombre',
     data: '<?php echo e(url("adminuser/productos.json")); ?>',
