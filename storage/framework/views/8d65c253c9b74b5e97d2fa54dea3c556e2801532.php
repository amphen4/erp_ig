<?php $__env->startSection('title','Editar O.T | Ventas'); ?>
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php endif; ?>
            <form class="form-horizontal form-label-left" id="formWow" method="POST" action="<?php echo e(url('ventasuser/ots').'/'.$ot->id); ?>">
            ...
            <div class="well" style="overflow: auto">
                ...
                <fieldset>
                  ...
                  <fieldset>
                    <div class="control-group ">
                      <div class="controls ">
                      	<a href="<?php echo e(url('ventasuser/ots')); ?>" class="btn btn-default">Cancelar</a><button form="formWow" type="submit" class="btn btn-primary">Guardar Cambios</button>
                      </div>
                    </div>
                  </fieldset>
              </div>
