...
<div class="">
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          <div class="x_title">
            <h2><i class="fa fa-pencil-square-o"></i> Orden de Trabajo N° <?php echo e($ot->id); ?> <small><?php echo e($ot->otestado->nombre); ?> << Vista de Usuario Produccion >></small></h2>
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-md-7">
	                      <div class='input-group date' id='Datepicker'>
                            <input type='text' name="fecha" readonly form="formWow" value="<?php echo e($ot->fecha); ?>" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class='input-group date' id='Datepicker2'>
                            <input type='text' name="fecha_entrega" form="formWow" required="required" class="form-control" />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
                      ...
                      <div class="col-md-7">
                        <input readonly value="<?php echo e($ot->nro); ?>" type="text" form="formWow" name="nro" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
