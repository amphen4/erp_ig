              ...
              <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade active in" id="tab_content4" aria-labelledby="home-tab">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <input value="<?php if($ot->cotizacion->cliente): ?><?php echo e($ot->cotizacion->cliente->nombre); ?><?php else: ?> Cliente Eliminado <?php endif; ?>" type="text"  name="cliente"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <input value="<?php if($ot->cotizacion->cliente): ?> <?php if($ot->cotizacion->cliente->empresa): ?><?php echo e($ot->cotizacion->cliente->empresa); ?><?php else: ?><?php echo e($ot->cotizacion->cliente->rut); ?><?php endif; ?> <?php else: ?> Cliente Eliminado <?php endif; ?>" type="text" name="rut"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
