...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" method="POST" action="<?php echo e(url('produccionuser/productos/').'/'.$producto->id); ?>" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?php echo e(url('/produccionuser/productos')); ?>" class="btn btn-primary" type="button">Cancelar</a>
