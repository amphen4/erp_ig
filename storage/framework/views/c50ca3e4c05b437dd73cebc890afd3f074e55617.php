                  ...
                  <?php endif; ?>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                          <td><button value="<?php echo e($fila->id); ?>"  class="btn btn-danger btn-xs btnEliminar">Eliminar</button><a href="<?php echo e(url('/adminuser/clientes').'/'.$fila->id.'/edit'); ?>"  class="btn btn-warning btn-xs ">Editar</a></td>
...
$('.btnEliminar').click(function(){
    if(confirm('Esta segur@? Si imprimirá algun reporte asociado al cliente, este mostrará cliente en blanco. ')){
      $.ajax({
        type: "POST",
        url: "<?php echo e(url('adminuser/clientes')); ?>"+'/'+$(this).val(),
