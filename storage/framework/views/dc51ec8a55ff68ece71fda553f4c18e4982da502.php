                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody id="bodyTabla">
                        ...
                        <tr>
                          <td><a href="<?php echo e(url('adminuser/reportes/').'/'.$fila->id); ?>"  class="btn btn-primery btn-xs ">Ver Historial</a></td>
    ...
    $.ajax({
      ...
      success: function(json) {
        ...
        for(var i=0; i<data['ots'].length; i++){
          ...
          wea.row.add(['<a href="<?php echo e(url('adminuser/reportes/').'/'); ?>'+data['ots'][i].id+'"  class="btn btn-primery btn-xs ">Ver Historial</a>',
                      data['ots'][i].id,
                      data['ots'][i].fecha,
                      data['otestado'][i],
