<?php $__env->startSection('title','Editar O.T | Administrador'); ?>
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php endif; ?>
            <form class="form-horizontal form-label-left" id="formWow" method="POST" action="<?php echo e(url('adminuser/ots').'/'.$ot->id); ?>">
            ...
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
              ...
              <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-md-7">
	                      <div class='input-group date' id='Datepicker'>
                            <input type='text' name="fecha" value="<?php echo e($ot->fecha); ?>" class="form-control" />
	                  ...
	                  <div class="form-group">
	                    <label class="control-label col-md-3" for="last-name">Fecha de Entrega: 
	                    </label>
	                    <div class="col-md-7">
	                      <input disabled type="text" id="last-name2"  required="required" class="form-control col-md-7 col-xs-12">
	                    </div>
	                  </div>
                    <div class="form-group">
                      <label class="control-label col-md-3" for="last-name">Comision Vendedor: <strong>$</strong>
                      </label>
                      <div class="col-md-7">
                        <input  type="text"  name="comision" id="comision" placeholder="dejar en blanco si pondra la orden en estado pendiente" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
	                  <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <input value="<?php echo e($ot->nro); ?>" type="text" id="last-name2" name="nro" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <textarea value="<?php echo e($ot->comentario); ?>" name="comentario" class="resizable_textarea form-control" ></textarea>
                      </div>
                    </div>
                </div>
            ...
            <div class="well" style="overflow: auto">
                ...
                <fieldset>
                  <div class="control-group ">
                    <div class="controls ">
                    	<a href="<?php echo e(url('adminuser/ots')); ?>" class="btn btn-default">Cancelar</a><button form="formWow" type="submit" class="btn btn-primary">Guardar Cambios</button>
                    </div>
                  </div>
                </fieldset>
            </div>
...
$('#formWow').submit(function(event){
    if(!confirm('Esta seguro de cambiar de estado: <?php echo e($ot->otestado->nombre); ?> a estado: '+$('#selectWow').val()+' ?')) event.preventDefault();
      ...
      $('#comision').val(comision.getRawValue());
    }
});
</script>
<script>
