<?php $__env->startSection('title','Administrar Usuarios Ventas'); ?>

<?php $__env->startSection('contenido'); ?>
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Usuarios Ventas </h2>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><button value="<?php echo e($user->id); ?>"  class="btn btn-danger btn-xs ">Eliminar</button>
...
<div  class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/adminuser/users/ventas')); ?>">
...
<form id="formEliminar" method="POST" action="<?php echo e(url('/adminuser/users/ventas')); ?>" enctype="multipart/form-data">
  <?php echo e(csrf_field()); ?>
