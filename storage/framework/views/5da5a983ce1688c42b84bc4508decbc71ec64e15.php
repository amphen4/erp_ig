<?php $__env->startSection('title','Ordenes de Trabajo | Ventas'); ?>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody id="bodyTabla">
                        ...
                        <tr>
                          <td><?php if($fila->otestado->nombre == 'ACTIVA'): ?><a href="<?php echo e(url('/ventasuser/ots').'/'.$fila->id.'/edit'); ?>"  class="btn btn-warning btn-xs ">Modificar</a><?php endif; ?></td>
                          ...
                          <td><a target="_blank" href="<?php echo e(url('ventasuser/reporteCotizacion').'/'.$fila->cotizacion->id); ?>"  class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> Cotizacion</a><a target="_blank" href="<?php echo e(url('ventasuser/reporteOt').'/'.$fila->id); ?>" class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> O.T</a></td>
...
<script>
  function aplicarFiltro(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(url('ventasuser/filtrarOts')); ?>",
      ...
      success: function(json) {
        ...
        for(var i=0; i<data['ots'].length; i++){
          ...
          var tiene = '';
          if(data['otestado'][i] == 'ACTIVA') tiene = '<a href="'+"<?php echo e(url('ventasuser/ots')); ?>"+'/'+data['ots'][i].id+'/edit" class="btn btn-warning btn-xs">Modificar</a>';
          wea.row.add([tiene,
                      data['ots'][i].id,
                      data['ots'][i].fecha,
                      data['otestado'][i],
                      ...
                      'Credito Nota',
                      data['adminuser'][i],
                      '<a target="_blank" href="<?php echo e(url("ventasuser/reporteCotizacion")); ?>'+'/'+data['idcotizacion'][i]+'" class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> Cotizacion</a><a href="<?php echo e(url("ventasuser/reporteOt")); ?>/'+data['ots'][i].id+'" class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> O.T</a>',
