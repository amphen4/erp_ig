                  ...
                  <?php endif; ?>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <?php if($fila->cliente): ?>
                            <td><?php echo e($fila->cliente->razon_social); ?></td>
                          <?php else: ?>
                          ...
                          <?php else: ?>
                            ...
                            <td></td>
                          <?php endif; ?>
                          <td><a target="_blank" href="<?php echo e(url('ventasuser/reporteCotizacion').'/'.$fila->id); ?>"  class="btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> Cotizacion</a></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
                    </table>
