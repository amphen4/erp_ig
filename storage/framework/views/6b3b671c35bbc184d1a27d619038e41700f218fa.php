			  ...
			  <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <button id="botonAgregar" class="btn btn-primary navbar-right" >Agregar nueva categoria</button>
                  ...
                  <?php endif; ?>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><a href="<?php echo e(url('/produccionuser/categorias').'/'.$fila->id.'/edit'); ?>"  class="btn btn-warning btn-xs ">Editar</a><!--<button   class="btn btn-danger btn-xs " value="<?php echo e($fila->id); ?>" >Eliminar</button>--></td>
...
<div  class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/produccionuser/categorias')); ?>">
...
<form id="formEliminar" method="POST" action="<?php echo e(url('/produccionuser/categorias/')); ?>" enctype="multipart/form-data">
  <?php echo e(csrf_field()); ?>
...
<script>
    ...
    $(".btn-danger").click(function(){
      ...
      {
        $('#formEliminar').attr('action',"<?php echo e(url('/produccionuser/categorias/')); ?>"+'/'+$(this).val());
        $('#formEliminar').submit();
      }  
    });
