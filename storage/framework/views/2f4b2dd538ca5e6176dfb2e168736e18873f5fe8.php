        ...
        <form id="wow" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" role="form" method="POST" action="<?php echo e(url('/ventasuser/cotizaciones')); ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input  type="text" class='flexdatalistproductos form-control col-md-7 col-xs-12'   data-data='<?php echo e(url("ventasuser/productos.json")); ?>' required="required" multiple='multiple' data-search-in='nombre'  data-min-length='1' >
              <br>
...
$('.flexdatalistcomunas').flexdatalist({
     minLength: 1,
     searchIn: 'name',
     data: '<?php echo e(url("/storage/comunas.json")); ?>',
     groupBy: 'region',
