<?php $__env->startSection('title','Cotizaciones por Vendedor'); ?>
	  ...
	  var theme = {
			  ...
			  echartPie.setOption({
				...
				series: [{
				  ...
				  radius: '55%',
				  center: ['50%', '48%'],
				  data: [<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>{
					value: <?php echo e($vendedor['valor']); ?>,
					name: '<?php echo e($vendedor['nombre']); ?>'
