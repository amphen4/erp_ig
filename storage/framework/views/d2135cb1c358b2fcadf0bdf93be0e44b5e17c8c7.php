	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-md-7">
	                      <div class='input-group date' id='Datepicker'>
                            <input type='text' name="fecha" readonly value="<?php echo e($ot->fecha); ?>" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class='input-group date' id='Datepicker2'>
                            <input readonly type='text' value="<?php echo e($ot->fecha_entrega); ?>" required="required" class="form-control" />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
                      ...
                      <div class="col-md-7">
                        <input readonly value="<?php echo e($ot->nro); ?>" type="text" id="last-name2" name="nro" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group ">
