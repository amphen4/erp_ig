<?php $__env->startSection('title','Editar O.T | Produccion'); ?>
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php endif; ?>
            <form class="form-horizontal form-label-left" id="formWow" method="POST" action="<?php echo e(url('produccionuser/ots').'/'.$ot->id); ?>">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-md-7">
	                      <div class='input-group date' id='Datepicker'>
                            <input type='text' name="fecha" disabled value="<?php echo e($ot->fecha); ?>" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class='input-group date' id='Datepicker2'>
                            <input type='text' name="fecha_entrega" required="required" class="form-control" />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
            ...
            <div class="well" style="overflow: auto">
            	<div class="col-md-4 ">
                    ...
                    <fieldset>
                      ...
                      <option disabled>FACTURADA</option>
                ...
                <fieldset>
                  <div class="control-group ">
                    <div class="controls ">
                    	<a href="<?php echo e(url('produccionuser/ots')); ?>" class="btn btn-default">Cancelar</a><button form="formWow" type="submit" class="btn btn-primary">Guardar Cambios</button>
                    </div>
                  </div>
                </fieldset>
            </div>
