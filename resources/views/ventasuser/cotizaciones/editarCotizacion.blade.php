  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="wow" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" role="form" method="POST" action="{{ url('/ventasuser/cotizaciones').'/'.$cotizacion->id }}">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
