...
@section('title','Editar O.T | Administrador')
@section('css')
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @endif
            <form class="form-horizontal form-label-left" id="formWow" method="POST" action="{{url('adminuser/ots').'/'.$ot->id}}">
            {{ method_field('PUT') }}
            {{ csrf_field() }}
              ...
              <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-md-7">
	                      <div class='input-group date' id='Datepicker'>
                            <input type='text' name="fecha" value="{{$ot->fecha}}" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <input value="{{$ot->nro}}" type="text" id="last-name2" name="nro" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <textarea value="{{$ot->comentario}}" name="comentario" class="resizable_textarea form-control" ></textarea>
                      </div>
                    </div>
                </div>
            ...
            <div class="well" style="overflow: auto">
                ...
                <fieldset>
                  <div class="control-group ">
                    <div class="controls ">
                    	<a href="{{url('adminuser/ots')}}" class="btn btn-default">Cancelar</a><button form="formWow" type="submit" class="btn btn-primary">Guardar Cambios</button>
                    </div>
                  </div>
                </fieldset>
            </div>
