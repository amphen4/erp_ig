...
<div class="">
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          <div class="x_title">
            <h2><i class="fa fa-pencil-square-o"></i> Orden de Trabajo N° {{$ot->id}} <small>{{$ot->otestado->nombre}} << Vista de Usuario Produccion >></small></h2>
              ...
              <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-md-7">
	                      <div class='input-group date' id='Datepicker'>
                            <input type='text' name="fecha" readonly form="formWow" value="{{$ot->fecha}}" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <input readonly value="{{$ot->nro}}" type="text" form="formWow" name="nro" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
