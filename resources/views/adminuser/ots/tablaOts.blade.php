...
@section('title','Ordenes de Trabajo | Administrador')
@section('css')
<!-- Datatables -->
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody id="bodyTabla">
                        ...
                        <tr>
                          <td><button value="{{$fila->id}}"  class="btn btn-danger btn-xs btnEliminar">Eliminar</button><a href="{{ url('/adminuser/ots').'/'.$fila->id.'/edit' }}"  class="btn btn-warning btn-xs ">Modificar</a></td>
                          <td>{{ $fila->id }}</td>
                          <td>{{ $fila->fecha }}</td>
