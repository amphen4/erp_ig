	                  ...
	                  <div class="form-group">
	                    ...
	                    <div class="col-md-7">
	                      <div class='input-group date' id='Datepicker'>
                            <input type='text' name="fecha" readonly value="{{$ot->fecha}}" class="form-control" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-7">
                        <div class='input-group date' id='Datepicker2'>
                            <input readonly type='text' value="{{$ot->fecha_entrega}}" required="required" class="form-control" />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
