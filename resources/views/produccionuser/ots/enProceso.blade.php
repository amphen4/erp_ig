...
@section('title','Editar O.T | Produccion')
@section('css')
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @endif
            <form class="form-horizontal form-label-left" id="formWow" method="POST" action="{{url('produccionuser/ots').'/'.$ot->id}}">
            {{ method_field('PUT') }}
            {{ csrf_field() }}
            ...
            <div class="well" style="overflow: auto">
                ...
                <fieldset>
                  <div class="control-group ">
                    <div class="controls ">
                    	<a href="{{url('produccionuser/ots')}}" class="btn btn-default">Cancelar</a><button form="formWow" type="submit" class="btn btn-primary">Guardar Cambios</button>
                    </div>
                  </div>
                </fieldset>
            </div>
